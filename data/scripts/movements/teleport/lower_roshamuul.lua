...
local lowerRoshamuul2 = MoveEvent()
...
function lowerRoshamuul2.onStepIn(creature, item, position, fromPosition)
    if not creature:isPlayer() then
        return false
    end
...
lowerRoshamuul2:type("stepin")
lowerRoshamuul2:id(20122)
lowerRoshamuul2:register()
