...
function secretServiceLever.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	...
	if getGlobalStorageValue(3632261) > 0 then
		player:say("The lever is stuck by the Stone Golem, it will be freed in 30 minutes.")
		return true
	end
	...
	setGlobalStorageValue(3632261, os.time() + 30 * 60)
	player:say("It seems, you have angered the technomancer.")
