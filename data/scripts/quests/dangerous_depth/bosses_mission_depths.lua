...
local bossesMissionDepthL = CreatureEvent("bossesMissionDepthL")
function bossesMissionDepthL.onLogin(player)
	player:registerEvent("BossesMissionDepth")
	return true
end
bossesMissionDepthL:register()
