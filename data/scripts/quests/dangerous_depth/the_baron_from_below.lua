...
local OrganicMatterKillL = CreatureEvent("OrganicMatterKillL")
function OrganicMatterKillL.onLogin(player)
	player:registerEvent("OrganicMatterKill")
	return true
end
OrganicMatterKillL:register()
