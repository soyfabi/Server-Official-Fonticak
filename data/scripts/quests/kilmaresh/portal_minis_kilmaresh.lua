...
function teleportBoss.onStepIn(creature, item, position, fromPosition)
	...
	for index, value in pairs(config) do
		if Tile(position) == Tile(value.teleportPosition) then
			...
			monster:setDirection(DIRECTION_NORTH)
			if not monster then
				return true
			end
			...
			creature:say("You have ten minutes to kill and loot this boss, else you will lose that chance and will be kicked out.")
