...
local quaraLeadersKillL = CreatureEvent("quaraLeadersKillL")
function quaraLeadersKillL.onLogin(player)
	player:registerEvent("QuaraLeaders")
	return true
end

quaraLeadersKillL:register()
