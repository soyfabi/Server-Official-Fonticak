...
local diseasedTrioKillL = CreatureEvent("diseasedTrioKillL")
function diseasedTrioKillL.onLogin(player)
	player:registerEvent("DiseasedTrio")
	return true
end

diseasedTrioKillL:register()
