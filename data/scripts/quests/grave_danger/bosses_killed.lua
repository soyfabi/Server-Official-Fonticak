...
local bossesGraveDangerL = CreatureEvent("GraveDangerKillL")
function bossesGraveDangerL.onLogin(player)
	player:registerEvent("GraveDangerKill")
	return true
end
bossesGraveDangerL:register()