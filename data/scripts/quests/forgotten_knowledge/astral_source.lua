...
function astralSource.onThink(creature)
	...
	if hp < 5.5 and getGlobalStorageValue(GlobalStorage.ForgottenKnowledge.AstralGlyph) >= 1 then
	...
	elseif getGlobalStorageValue(GlobalStorage.ForgottenKnowledge.AstralGlyph) < 1 then
