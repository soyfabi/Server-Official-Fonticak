...
local bossesForgottenKill2 = CreatureEvent("bossesForgottenKill2")
function bossesForgottenKill2.onLogin(player)
	player:registerEvent("BossesForgottenKill")
	return true
end

bossesForgottenKill2:register()
