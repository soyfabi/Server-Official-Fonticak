...
function versperothKill.onKill(creature, target)
	...
	setGlobalStorageValue(GlobalStorage.BigfootBurden.Versperoth.Battle, 2)
	addEvent(setGlobalStorageValue, 30 * 60 * 1000, GlobalStorage.BigfootBurden.Versperoth.Battle, 0)
...
local versperothKillL = CreatureEvent("versperothKillL")
function versperothKillL.onLogin(player)
	player:registerEvent("VersperothKill")
	return true
end
versperothKillL:register()
