...
local lizardMagistratusKillL = CreatureEvent("lizardMagistratusKillL")
function lizardMagistratusKillL.onLogin(player)
	player:registerEvent("LizardMagistratusKill")
	return true
end

lizardMagistratusKillL:register()
