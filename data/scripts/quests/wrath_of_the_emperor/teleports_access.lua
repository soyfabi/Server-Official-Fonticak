...
local config =
{
	{Access = Storage.WrathoftheEmperor.TeleportAccess.Rebel, teleportPos = Position(33136, 31248, 6), destinationA = Position(33211, 31065, 9), destinationB = Position(33137, 31247, 6)},
...
function teleport.onStepIn(creature, item, position, fromPosition)
	...
	creature:say("It seems the teleporter is not working properly.")
