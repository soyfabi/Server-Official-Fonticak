...
function wrathEmperorMiss3Keeper.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	if item.itemid == 11364 and target.actionid == 8026 then
		if getGlobalStorageValue(Storage.WrathoftheEmperor.Mission03) < 5 then
			setGlobalStorageValue(Storage.WrathoftheEmperor.Mission03, math.max(0, getGlobalStorageValue(Storage.WrathoftheEmperor.Mission03)) + 1)
		...
		elseif Game.getStorageValue(Storage.WrathoftheEmperor.Mission03) == 5 then
			...
			setGlobalStorageValue(Storage.WrathoftheEmperor.Mission03, 6)
