...
local lizardNobleKillL = CreatureEvent("lizardNobleKillL")
function lizardNobleKillL.onLogin(player)
	player:registerEvent("LizardNobleKill")
	return true
end

lizardNobleKillL:register()
