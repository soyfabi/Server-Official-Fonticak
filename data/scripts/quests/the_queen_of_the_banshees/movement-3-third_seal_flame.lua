...
function thirdSealFlame.onStepIn(creature, item, position, fromPosition)
	...
	if player:getStorageValue(Storage.Quest.U7_2.TheQueenOfTheBanshees.ThirdSeal) >= 1 or getGlobalStorageValue('switchNum') ~= 6 then
	...
	player:setStorageValue(Storage.Quest.U7_2.TheQueenOfTheBanshees.QuestLine, 1)
