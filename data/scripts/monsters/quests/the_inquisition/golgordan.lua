...
monster.attacks = {
	...
	-- poison
	{name ="condition", condition = {type = CONDITION_POISON, interval = 1000, chance = 11, minDamage = -30, maxDamage = -30}, length = 5, spread = 3, effect = CONST_ME_POISONAREA, target = false},
