...
monster.attacks = {
	...
	-- energy damage
	{name ="condition", condition = {type = CONDITION_ENERGY, interval = 2000, chance = 20, minDamage = -2000, maxDamage = -2000}, radius = 7, effect = CONST_ME_BLOCKHIT, target = false},
	-- bleed
	{name ="condition", condition = {type = CONDITION_BLEEDING, interval = 2000, chance = 20, minDamage = -2000, maxDamage = -2000}, length = 9, spread = 3, effect = CONST_ME_BLOCKHIT, target = false}
}
