...
monster.attacks = {
	...
	{name ="energy strike_2", interval = 2000, chance = 30, minDamage = -50, maxDamage = -180, range = 1, target = false},
	-- energy damage
	{name ="condition", condition = {type = CONDITION_ENERGY, interval = 1000, chance = 15}, radius = 3, effect = CONST_ME_YELLOWENERGY, target = false}
}
