...
monster.attacks = {
	...
	-- poison
	{name ="condition", condition = {type = CONDITION_POISON, interval = 2000, chance = 22, minDamage = -1000, maxDamage = -1800}, length = 8, spread = 3, effect = CONST_ME_POISONAREA, target = false},
	-- poison
	{name ="condition", condition = {type = CONDITION_POISON, interval = 2000, chance = 15, minDamage = -80, maxDamage = -80}, radius = 3, effect = CONST_ME_POISONAREA, target = false},
