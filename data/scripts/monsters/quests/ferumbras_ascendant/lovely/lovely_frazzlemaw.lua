...
monster.attacks = {
	...
	-- bleed
	{name ="condition", condition = {type = CONDITION_BLEEDING, interval = 2000, chance = 16, minDamage = -400, maxDamage = -600}, radius = 2, shootEffect = CONST_ANI_LARGEROCK, effect = CONST_ME_STONES, target = true},
