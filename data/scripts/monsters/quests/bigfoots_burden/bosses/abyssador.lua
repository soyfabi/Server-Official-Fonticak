...
monster.attacks = {
	...
	-- energy damage
	{name ="condition", condition = {type = CONDITION_ENERGY, interval = 1000, chance = 10, minDamage = -800, maxDamage = -800}, radius = 4, shootEffect = CONST_ANI_POISON, effect = CONST_ME_SMALLPLANTS, target = false},
