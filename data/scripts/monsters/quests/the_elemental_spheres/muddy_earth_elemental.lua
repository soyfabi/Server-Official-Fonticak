...
monster.attacks = {
	...
	-- poison
	{name ="condition", condition = {type = CONDITION_POISON, interval = 1000, chance = 10, minDamage = 0, maxDamage = -26}, length = 6, spread = 3, effect = CONST_ME_GROUNDSHAKER, target = false}
}
