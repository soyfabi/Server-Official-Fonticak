...
monster.attacks = {
	...
	-- poison
	{name ="condition", condition = {type = CONDITION_POISON, interval = 2000, chance = 22, minDamage = -5, maxDamage = -5}, length = 6, spread = 3, effect = CONST_ME_SMALLPLANTS, target = false},
	-- poison
	{name ="condition", condition = {type = CONDITION_POISON, interval = 2000, chance = 15, minDamage = -4, maxDamage = -4}, radius = 3, effect = CONST_ME_POISONAREA, target = false},
