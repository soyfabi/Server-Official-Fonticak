...
monster.attacks = {
	...
	-- poison
	{name ="condition", condition = {type = CONDITION_POISON, interval = 2000, chance = 15, minDamage = -12, maxDamage = -12}, length = 4, spread = 3, effect = CONST_ME_POISONAREA, target = false}
}
