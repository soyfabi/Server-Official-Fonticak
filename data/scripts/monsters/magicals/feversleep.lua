...
monster.attacks = {
	...
	-- poison
	{name ="condition", condition = {type = CONDITION_POISON, interval = 2000, chance = 20, minDamage = -800, maxDamage = -1000}, radius = 7, effect = CONST_ME_YELLOW_RINGS, target = false},
