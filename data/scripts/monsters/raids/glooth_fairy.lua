...
monster.attacks = {
	...
	-- fire
	{name ="condition", condition = {type = CONDITION_FIRE, interval = 1000, chance = 7, minDamage = -200, maxDamage = -1000}, range = 2, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_BLOCKHIT, target = false},
