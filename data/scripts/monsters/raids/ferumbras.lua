...
monster.attacks = {
	...
	-- poison
	{name ="condition", condition = {type = CONDITION_POISON, interval = 2000, chance = 15, minDamage = -20, maxDamage = -40}, range = 7, shootEffect = CONST_ANI_POISON, target = false},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_LIFEDRAIN, minDamage = -900, maxDamage = -1000, range = 4, radius = 3, target = false},
	-- energy damage
	{name ="condition", condition = {type = CONDITION_ENERGY, interval = 2000, chance = 18, minDamage = -300, maxDamage = -400}, radius = 6, effect = CONST_ME_ENERGYHIT, target = false},
	-- fire
	{name ="condition", condition = {type = CONDITION_FIRE, interval = 3000, chance = 20, minDamage = -500, maxDamage = -600}, range = 7, radius = 7, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true}
}
