...
monster.attacks = {
	...
	-- poison
	{name ="condition", condition = {type = CONDITION_POISON, interval = 3000, chance = 13, minDamage = -10, maxDamage = -10}, range = 5, shootEffect = CONST_ANI_POISON, target = false},
...
monster.defenses = {
	...
	{name ="outfit", interval = 4000, chance = 9, effect = CONST_ME_MAGIC_RED, target = false, duration = 4000, monster = "green frog"}
}
