...
monster.attacks = {
	...
	-- poison
	{name ="condition", condition = {type = CONDITION_POISON, interval = 2000, chance = 15, minDamage = -20, maxDamage = -240}, length = 8, spread = 3, effect = CONST_ME_POISONAREA, target = false},
