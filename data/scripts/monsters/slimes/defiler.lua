...
monster.attacks = {
	...
	-- poison
	{name ="condition", condition = {type = CONDITION_POISON, interval = 2000, chance = 15, minDamage = -400, maxDamage = -640}, range = 7, radius = 7, effect = CONST_ME_HITBYPOISON, target = false},
	...
	-- poison
	{name ="condition", condition = {type = CONDITION_POISON, interval = 2000, chance = 10, minDamage = -500, maxDamage = -1000}, length = 8, spread = 3, effect = CONST_ME_SMALLPLANTS, target = false},
