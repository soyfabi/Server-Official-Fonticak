...
monster.attacks = {
	...
	-- poison
	{name ="condition", condition = {type = CONDITION_POISON, interval = 2000, chance = 10, minDamage = -50, maxDamage = -60}, radius = 3, effect = CONST_ME_POISONAREA, target = false},
	-- poison
	{name ="condition", condition = {type = CONDITION_POISON, interval = 2000, chance = 10, minDamage = -70, maxDamage = -80}, length = 6, spread = 3, effect = CONST_ME_POISONAREA, target = false},
