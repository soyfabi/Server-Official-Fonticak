...
monster.attacks = {
	...
	-- poison
	{name ="condition", condition = {type = CONDITION_POISON, interval = 2000, chance = 10, minDamage = -300, maxDamage = -400}, length = 7, spread = 3, effect = CONST_ME_HITBYPOISON, target = false},
