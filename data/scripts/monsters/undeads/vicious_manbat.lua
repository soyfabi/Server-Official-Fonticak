...
monster.attacks = {
	...
	{name = "speed", chance = 15, interval = 2000, speed = -400, radius = 1, effect = CONST_ME_BATS, target = true, duration = 20000},
	-- bleed
	{name ="condition", condition = {type = CONDITION_BLEEDING, interval = 2000, chance = 20, minDamage = -400, maxDamage = -600}, radius = 2, target = false}
}
