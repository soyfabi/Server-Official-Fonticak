...
monster.attacks = {
	...
	{name = "speed", chance = 18, interval = 2000, speed = -400, range = 7, length = 7, radius = 4, effect = CONST_ME_ICETORNADO, target = true, duration = 20000},
	...
	{name = "speed", chance = 12, interval = 2000, speed = -400, length = 7, spread = 3, effect = CONST_ME_ICEATTACK, target = false, duration = 20000},
