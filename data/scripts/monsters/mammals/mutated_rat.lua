...
monster.attacks = {
	...
	-- poison
	{name ="condition", condition = {type = CONDITION_POISON, interval = 2000, chance = 10, minDamage = -80, maxDamage = -100}, length = 5, spread = 3, effect = CONST_ME_POISONAREA, target = false},
	...
	-- poison
	{name ="condition", condition = {type = CONDITION_POISON, interval = 2000, chance = 10}, range = 7, radius = 3, effect = CONST_ME_POISONAREA, target = false}
}
