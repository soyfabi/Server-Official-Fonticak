...
monster.attacks = {
	...
	{name ="sudden death rune_2", interval = 2000, chance = 15, minDamage = -150, maxDamage = -350, range = 3, length = 6, spread = 3, effect = CONST_ME_MORTAREA, target = false},
	...
	{name ="sudden death rune_2", interval = 2000, chance = 15, minDamage = -70, maxDamage = -250, range = 7, target = false},
