...
monster.attacks = {
	...
	-- bleed
	{name ="condition", condition = {type = CONDITION_BLEEDING, interval = 2000, chance = 40, minDamage = -300, maxDamage = -400}, range = 7, radius = 3, shootEffect = CONST_ANI_THROWINGKNIFE, effect = CONST_ME_HITAREA, target = true},
