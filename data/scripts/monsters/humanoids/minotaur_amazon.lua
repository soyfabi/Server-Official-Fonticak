...
monster.attacks = {
	...
	-- bleed
	{name ="condition", condition = {type = CONDITION_BLEEDING, interval = 2000, chance = 40, minDamage = -300, maxDamage = -400}, radius = 4, shootEffect = CONST_ANI_THROWINGKNIFE, target = true},
