...
monster.attacks = {
	...
	-- energy damage
	{name ="condition", condition = {type = CONDITION_ENERGY, interval = 2000, chance = 20, minDamage = -300, maxDamage = -600}, range = 6, radius = 4, shootEffect = CONST_ANI_ENERGY, effect = CONST_ME_PURPLEENERGY, target = true}
}
