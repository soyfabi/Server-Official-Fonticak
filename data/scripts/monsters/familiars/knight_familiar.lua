...
monster.attacks = {
	...
	{name ="sudden death rune_2", interval = 2000, chance = 17, minDamage = -300, maxDamage = -350, range = 7, target = false},
	...
	{name ="ice strike_2", interval = 2000, chance = 17, minDamage = -300, maxDamage = -350, range = 5, target = true}
}
