...
monster.attacks = {
	...
	-- curse
	{name ="condition", condition = {type = CONDITION_CURSED, interval = 2000, chance = 50, minDamage = -100, maxDamage = -200}, radius = 4, shootEffect = CONST_ANI_WHIRLWINDCLUB, effect = CONST_ME_EXPLOSIONAREA, target = true}
}
