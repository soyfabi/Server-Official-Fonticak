...
monster.attacks = {
	...
	-- poison
	{name ="condition", condition = {type = CONDITION_POISON, interval = 2000, chance = 15, minDamage = -240, maxDamage = -320}, length = 3, spread = 2, effect = CONST_ME_POISONAREA, target = false},
