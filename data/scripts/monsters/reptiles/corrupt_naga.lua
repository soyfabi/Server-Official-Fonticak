...
monster.loot = {
	{name = "Platinum Coin", chance = 75420, maxCount = 8},
	{name = "Violet Crystal Shard", chance = 24580, maxCount = 2},
	{name = "Corrupt Naga Scales", chance = 17720},
}

monster.attacks = {
    {name ="combat", interval = 2000, type = COMBAT_DEATHDAMAGE, chance = 100, minDamage = -300, maxDamage = -600, shootEffect = CONST_ANI_EXPLOSION, effect = CONST_ME_PURPLEENERGY, target = true},
