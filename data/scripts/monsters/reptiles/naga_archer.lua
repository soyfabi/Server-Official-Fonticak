...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, minDamage = 300, maxDamage = 600, type = COMBAT_PHYSICALDAMAGE, range = 7, shootEffect = CONST_ANI_EXPLOSION, effect = CONST_ME_PURPLEENERGY, target = true},
