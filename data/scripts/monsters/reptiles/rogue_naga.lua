...
monster.loot = {
	{name = "Platinum Coin", chance = 85600, maxCount = 12},
	{name = "Rogue Naga Scales", chance = 15450},
	{name = "Green Crystal Shard", chance = 14400, maxCount = 2},
}

monster.attacks = {
    {name ="combat", interval = 2000, chance = 100, type = COMBAT_PHYSICALDAMAGE, minDamage = -300, maxDamage = -600, shootEffect = CONST_ANI_EXPLOSION, effect = CONST_ME_PURPLEENERGY, target = true},
