...
monster.attacks = {
	...
	-- poison
	{name ="condition", condition = {type = CONDITION_POISON, interval = 2000, chance = 15, minDamage = -100, maxDamage = -160}, range = 7, radius = 1, shootEffect = CONST_ANI_POISON, target = true}
}
