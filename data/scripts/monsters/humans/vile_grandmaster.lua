...
monster.attacks = {
	...
	-- bleed
	{name ="condition", condition = {type = CONDITION_BLEEDING, interval = 2000, chance = 20, minDamage = -150, maxDamage = -225}, radius = 4, shootEffect = CONST_ANI_THROWINGKNIFE, target = true}
}
