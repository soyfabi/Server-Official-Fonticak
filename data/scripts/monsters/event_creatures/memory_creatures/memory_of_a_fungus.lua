...
monster.attacks = {
	...
	-- poison
	{name ="condition", condition = {type = CONDITION_POISON, interval = 2000, chance = 10, minDamage = -30, maxDamage = -150}, length = 8, spread = 3, effect = CONST_ME_GREEN_RINGS, target = false},
	...
	-- poison
	{name ="condition", condition = {type = CONDITION_POISON, interval = 2000, chance = 10, minDamage = -50, maxDamage = -180}, range = 7, radius = 3, effect = CONST_ME_HITBYPOISON, target = false}
}
