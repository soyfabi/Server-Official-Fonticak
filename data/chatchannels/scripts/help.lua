...
function onLeave(player)
    sendChannelMessage(CHANNEL_HELP, TALKTYPE_CHANNEL_R1, string.format("[BOT]: The player %s (%d) has been disconnected from the channel.", player:getName(), player:getLevel()))
    return false
end