...
local buyList = {
	...
	{ name = "brown bread", id = 3602, buy = 3 },
	{ name = "carrot", id = 3595, buy = 2 },
	{ name = "cheese", id = 3607, buy = 5 },
...
local function creatureSayCallback(cid, type, msg)
	if isInArray({"trade", "offer", "shop", "trad", "tra", "tradde", "tradee", "tade"}, msg:lower()) then
		...
		npcHandler:say("I sell food and fruits, take advantage of the daily offers.", cid)
	end
	return true
end
