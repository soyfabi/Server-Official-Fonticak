...
local function getTable()
	local itemsList = {
		{name = "bell", id = 15832, buy = 50},
		{name = "gnomish crystal package", id = 15802, buy = 1000},
		{name = "gnomish extraction crystal", id = 15696, buy = 50},
		{name = "gnomish repair crystal", id = 15703, buy = 50},
		{name = "gnomish spore gatherer", id = 15821, buy = 50},
		{name = "little pig", id = 15828, buy = 150}
	}
	return itemsList
end
