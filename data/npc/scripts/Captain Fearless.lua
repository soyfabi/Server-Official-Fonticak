...
local function addTravelKeyword(keyword, cost, destination, condition)
	...
	local travelKeyword = keywordHandler:addKeyword({keyword}, StdModule.say, {npcHandler = npcHandler, text = 'Would you like to go to {' .. keyword:titleCase() .. '} for {'.. cost ..' gold coins}?', cost = cost, discount = 'postman'})
