...
elseif msgcontains(msg, "yes") and playerTopic[cid] == 3 and player:getStorageValue(Storage.KilmareshQuest.Eighth.Yonan) == 2 then
	if player:getStorageValue(Storage.KilmareshQuest.Eighth.Yonan) == 2 and player:getItemById(9651, 3) and player:getItemById(36160, 12) and player:getItemById(36168, 10) then
