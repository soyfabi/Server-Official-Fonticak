...
local function greetCallback(cid)
	local player = Player(cid)
	npcHandler:setMessage(MESSAGE_GREET, "Welcome, "..player:getName()..", take a look and see if something beutiful catches your fancy. Ask me for a {trade} when you have made your choice.")
	return true
end
