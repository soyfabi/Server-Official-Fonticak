...
-- Thais
local travelKeyword = keywordHandler:addKeyword({'thais'}, StdModule.say, {npcHandler = npcHandler, text = 'Do you seek a passage to {Thais} for {400 gold coins}?', cost = 180, discount = 'postman'})
