...
local function creatureSayCallback(cid, type, msg)
	...
	if player:getStorageValue(Storage.CultsOfTibia.MotA.Mission) < 2 then
		if msgcontains(msg, "support") then --and npcHandler.topic[cid] == 1 then
		...
		elseif msgcontains(msg, "yes") or msgcontains(msg, "pay") then 
	...
	if msgcontains(msg, "extension") and player:getStorageValue(Storage.TheSecretLibrary.LiquidDeath) == 13 then
		if player:getStorageValue(Storage.TheSecretLibrary.LiquidDeath) == 13 then
	...
	elseif msgcontains(msg, "yes") and npcHandler.topic[cid] == 12 then
		if npcHandler.topic[cid] == 12 then
			...
			player:setStorageValue(Storage.TheSecretLibrary.LiquidDeath, 14)
