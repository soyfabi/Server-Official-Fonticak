...
local function getTable(player)
	...
	{ name = "red lantern", id = 10289, sell = 250 },
	...
	{ name = "twin hooks", id = 10392, buy = 1100 },
	{ name = "zaoan halberd", id = 10406, buy = 1200 },
	...
	{name = "twin hooks", id = 10392, sell = 500},
	{name = "zaoan halberd", id = 10406, sell = 500},
	...
	if player:getStorageValue(TomeofKnowledge) >= 3 then
		-- 3 tomes
		for i = 1, #tomes[1] do
	...
	if player:getStorageValue(TomeofKnowledge) >= 9 then
		-- 9 tomes
		for i = 1, #tomes[2] do
